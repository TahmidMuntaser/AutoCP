    ...
    <div className="relative z-10 min-h-screen py-6">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h2 className="text-3xl font-bold text-white mb-2">Generated Problems History</h2>
            <p className="text-gray-400 text-sm">{problems.length} problem{problems.length !== 1 ? 's' : ''} in history</p>
          </div>
          <button
        ...
        {loading ? (
          ...
          <div className="bg-[#00303d]/60 backdrop-blur-xl border border-blue-500/20 rounded-2xl p-12 text-center">
            ...
            <p className="text-gray-400">Generated problems will appear here</p>
          </div>
        ) : (
          <div className="space-y-2">
